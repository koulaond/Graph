                    ...
                    assertThat(nodeDesc.getPropertyDescriptions())
                            ...
                            .satisfies(propDescs -> {
                                Map<String, PropertyDescription> collectedProps = ((Set<PropertyDescription>) propDescs)
                                        .stream()
                                        .collect(toMap(PropertyDescription::getName, Function.identity()));

                                assertThat(collectedProps.get(PROP_NAME))
                                        .isNotNull()
                                        .isInstanceOf(StringPropertyDescription.class)
                                        .satisfies(prop -> {
                                            assertThat(prop.getName()).isEqualTo(PROP_NAME);
                                ...
                                assertThat(collectedProps.get(PROP_SIZE))
                                        ...
                                        .satisfies(prop -> {
                                            assertThat(prop.getName()).isEqualTo(PROP_SIZE);
                                ...
                                assertThat(collectedProps.get(PROP_DAY))
                                        ...
                                        .isInstanceOf(NumericPropertyDescription.class)
                                        .satisfies(prop -> {
                                            assertThat(prop.getName()).isEqualTo(PROP_DAY);
                                ...
                                assertThat(collectedProps.get(PROP_DATE))
                                        ...
                                        .isInstanceOf(StringPropertyDescription.class)
                                        .satisfies(prop -> {
                                            assertThat(prop.getName()).isEqualTo(PROP_DATE);
                                ...
                                assertThat(collectedProps.get(PROP_DEPTH))
                                        ...
                                        .isInstanceOf(NumericPropertyDescription.class)
                                        .satisfies(prop -> {
                                            assertThat(prop.getName()).isEqualTo(PROP_DEPTH);
                                        });
                                ...
                                assertThat(collectedProps.get(PROP_EXTENDED_INFO))
                                        ...
                                        .isInstanceOf(StringPropertyDescription.class)
                                        .satisfies(prop -> {
                                            assertThat(prop.getName()).isEqualTo(PROP_EXTENDED_INFO);
                                        });
                            });
                    ...
                    assertThat(nodeDesc.getRelationshipDescriptions())
                            ...
                            .satisfies(rels -> {
                                assertThat(rels.iterator().next())
                                        .isNotNull()
                                        .satisfies(relation -> {
                                            assertThat(relation.getName()).isEqualTo(REL_SIBLING);
